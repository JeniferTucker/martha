...
/* Display: Events */
$handler = $view->new_display('page', 'Events', 'page_4');
$handler->display->display_options['defaults']['title'] = FALSE;
...
$handler->display->display_options['menu']['description'] = 'Calendar of events';
$handler->display->display_options['menu']['weight'] = '0';
...
/* Display: Eventi */
$handler = $view->new_display('page', 'Eventi', 'page_5');
$handler->display->display_options['defaults']['title'] = FALSE;
$handler->display->display_options['title'] = 'Calendario degli Eventi';
$handler->display->display_options['defaults']['pager'] = FALSE;
$handler->display->display_options['pager']['type'] = 'date_views_pager';
$handler->display->display_options['pager']['options']['date_id'] = 'month';
$handler->display->display_options['pager']['options']['link_format'] = 'clean';
...
$handler->display->display_options['path'] = 'eventi';
$handler->display->display_options['menu']['type'] = 'normal';
$handler->display->display_options['menu']['title'] = 'Eventi';
$handler->display->display_options['menu']['description'] = 'Calendario degli Eventi';
$handler->display->display_options['menu']['weight'] = '0';
$handler->display->display_options['menu']['name'] = 'main-menu';
$handler->display->display_options['menu']['context'] = 0;
$handler->display->display_options['menu']['context_only_inline'] = 0;
...
/* Display: Latest events (en) */
$handler = $view->new_display('panel_pane', 'Latest events (en)', 'panel_pane_2');
$handler->display->display_options['defaults']['title'] = FALSE;
...
/* Display: Latest news (en) */
$handler = $view->new_display('panel_pane', 'Latest news (en)', 'panel_pane_1');
$handler->display->display_options['defaults']['pager'] = FALSE;
$handler->display->display_options['pager']['type'] = 'some';
$handler->display->display_options['pager']['options']['items_per_page'] = '3';
$handler->display->display_options['pager']['options']['offset'] = '0';
...
/* Display: Latest events (it) */
$handler = $view->new_display('panel_pane', 'Latest events (it)', 'panel_pane_3');
$handler->display->display_options['defaults']['title'] = FALSE;
$handler->display->display_options['title'] = 'Ultimi eventi';
$handler->display->display_options['defaults']['pager'] = FALSE;
$handler->display->display_options['pager']['type'] = 'some';
$handler->display->display_options['pager']['options']['items_per_page'] = '3';
$handler->display->display_options['pager']['options']['offset'] = '0';
...
/* Display: Latest news (it) */
$handler = $view->new_display('panel_pane', 'Latest news (it)', 'panel_pane_4');
$handler->display->display_options['defaults']['title'] = FALSE;
