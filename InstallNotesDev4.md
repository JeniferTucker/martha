...
[admin@server~]
    ...
    # Load latest backup into empty database.
        mysql \
            ...
            < /var/local/backups/ixis/sanctuary-ixis.example.com-20130428034739.sql
...
http://dev1.example.com/admin/structure/menu/manage/management
...
http://dev1.example.com/admin/appearance/settings
